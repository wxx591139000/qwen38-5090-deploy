...
> 版本：v1.3 ｜ 2026-08-23 ｜ **完整归档 v2**：克隆生态(5090/vGPU/clone1/clone2) + Hermes qwen-思考接入 + 思考成本专业压测

> **已归档**（最新）：`archive-20260823-v2`（2026-08-23）——qwen38 生态运维 + Hermes qwen-思考开发 全链路冻结
> 历史归档：`archive-20260820`（部署+ACP）、`archive-20260823`（克隆切换+压测+DFlash2+vGPU延伸）
> 续接：说「按交接提示继续」→ 读 `docs/接交接.md` + 记忆 `qwen38-clone-switch-resume-handoff`
